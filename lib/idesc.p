...
def IDesc : * -> * = %IDesc
def IEnd : {I : *} -> I -> IDesc I = \{I} i. %IEnd I i
def IArg : {I A : *} -> (A -> IDesc I) -> IDesc I = \{I} {A} f. %IArg I A f
def IFArg : {I : *} -> * -> IDesc I -> IDesc I = \{I} A d. %IFArg I A d
def IRec : {I : *} -> I -> IDesc I -> IDesc I = \{I} i d. %IRec I i d
def IHRec : {I A : *} -> (A -> I) -> IDesc I -> IDesc I = \{I} {A} fi d. %IHRec I A fi d
...
def allIDesc : {I : *} -> (d : IDesc I) -> (X : I -> *) -> (P : (i : I) -> X i -> *) -> ((i : I) -> (x : X i) -> P i x) -> (i : I) -> (xs : interpI {I} d X i) -> AllIDesc I d X P i xs = \{I}. %allI I
